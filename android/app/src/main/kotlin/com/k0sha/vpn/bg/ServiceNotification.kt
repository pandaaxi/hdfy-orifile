...
import com.k0sha.vpn.Application
import com.k0sha.vpn.MainActivity
import com.k0sha.vpn.R
import com.k0sha.vpn.Settings
import com.k0sha.vpn.constant.Action
import com.k0sha.vpn.constant.Status
import com.k0sha.vpn.utils.CommandClient
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        ...
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "k0sha VPN")
